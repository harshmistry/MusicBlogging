...
public class ShowRecommendedUserDAO {
	public List<UserBean> fetchRecommendedArtist(String userId) throws ConnectionFailureException, SQLException, IOException{
		List<UserBean> recommdUserList=new ArrayList<UserBean>();
		Connection conn=DBManager.getConnection();
		CallableStatement callableStatement=conn.prepareCall("call SHOW_RECOMMENDED_USER_PROC(?,?,?)");
