...
<center>List of recommended users for you</center>
...
<body>
<form name="recommendedUserForm" method="post" action="RecommendedUserConstroller">
	<table align="right">
	<tr>
		<td align="right"><a href="SignoutController">sign out</a>&nbsp;&nbsp;&nbsp;<a href="HomePageController">homepage</a></td>
	</tr>
	</table><br/><br/><br/><br/>
	<%List<UserBean> recommendedUserList = (List<UserBean>)request.getAttribute("recommendedUserList"); %>
	<%if(null!=recommendedUserList && !recommendedUserList.isEmpty()){ 
		if(null!=request.getAttribute("noArtistSelected") && request.getAttribute("noArtistSelected").equals("true")){%>
		<center><font color="red">Please select a user to follow</font></center>
		...
		<table align="center" border=1 width=50% id="tfhover" class="tftable">
			...
			<%for(UserBean userBean: recommendedUserList){%>
					<tr>
						<td><input type="checkbox" name="reccomdedUserSelected" value=<%=userBean.getUserid() %>></td>
	...
	<%}else{ %>
		<center>No user suggestion found at this moment, please click on continue to visit your homepage</center>
	<%} %>
</form>
</body>
</html>