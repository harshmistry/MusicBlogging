...
<title>Concerts attended</title>
<center>Concerts attended by you</center>
...
<body>
<form name="showconcertattended" method="get" action="WritePostController">
<table align="right">
	<tr>
		<td align="right"><a href="SignoutController">sign out</a>&nbsp;&nbsp;&nbsp;<a href="HomePageController">homepage</a></td>
	</tr>
</table>
	<%List<ConcertDetailsBean> concertAttendedList=(List<ConcertDetailsBean>)request.getAttribute("concertAttendedList") ;
	if(null!=concertAttendedList && !concertAttendedList.isEmpty()){%>
		<table align="center" border=1 id="tfhover" class="tftable">
			...
			<%for(ConcertDetailsBean concertDetailsBean:concertAttendedList){ %>
			<tr>
				<td align="center"><input type="radio" name="writepostfor" value=<%=concertDetailsBean.getConcert_id() %>></td>
			...
			<%} %>
			<tr>
				<td align="center" colspan=10><input type="submit" value="Write post" class="button"></td>
			</tr>
		</table>
	<%}else{ %>
	<center>You haven't attended any concerts, please check <a href="ShowUpCmngCocrtCntrl">upcoming concerts</a> </center>
	<%} %>
</form>
</body>
</html>