...
<title>Concerts that you are attending</title>
<center>Concerts taht you are attending</center>
...
<body>
<form name="showconcertattending" method="post" action="ShowCncrtAttendingCntllr">
<table align="right">
	<tr>
...
<br/><br/><br/><br/>
	<%List<ConcertDetailsBean> concertAttendingList=(List<ConcertDetailsBean>)request.getAttribute("concertAttendingList") ;
	if(null!=concertAttendingList && !concertAttendingList.isEmpty()){
		if(null!=request.getAttribute("concertNotSelectedtoDel")&&request.getAttribute("concertNotSelectedtoDel").equals("true")){%>
		<center><font color="red">Please select a concert to remove from attending list</font></center>
		<%	request.setAttribute("concertNotSelectedtoDel", "false");
		} %>
		<table align="center" border=1 id="tfhover" class="tftable">
			...
			<%for(ConcertDetailsBean concertDetailsBean:concertAttendingList){ %>
			<tr>
				<td align="center"><input type="checkbox" name="deleteConcertAttending" value=<%=concertDetailsBean.getConcert_id() %>></td>
			...
			<%} %>
			<tr>
				<td align="center" colspan=10><input type="submit" value="Remove from attending list" class="button"></td>
			</tr>
		</table>
	<%}else{ %>
	<center>You are not attending any concerts, please check <a href="ShowUpCmngCocrtCntrl">upcoming concerts</a> </center>
	<%} %>
</form>
</body>
</html>