...
<title>List recommended by you</title>
<center>Concerts recommended by you</center>
...
<body>
<form name="selfRecommdCncrtList" method="post" action="ViewYourRecommdCntllr">
	<table align="right">
	<tr>
	...
	<br/><br/><br/><br/><br/>
	<%List<ConcertDetailsBean> selfRecomendConcertList=(List<ConcertDetailsBean>)request.getAttribute("selfRecomendConcertList");
	if(null!=selfRecomendConcertList && !selfRecomendConcertList.isEmpty()){ 
	...
	<table align="center" id="tfhover" class="tftable" border=1>
		<tr>
			...
			<%for(ConcertDetailsBean concertDetailsBean:selfRecomendConcertList){ %>
			<tr>
				<td align="center"><input type="checkbox" name="recomdToBeDel" value=<%=concertDetailsBean.getConcert_id() %>></td>
			...
			<%} %>
			<tr>
				<td align="center" colspan=10><input type="submit" value="Delete recommendation" class="button"></td>
			</tr>
	</table>
	<%}else{ %>
