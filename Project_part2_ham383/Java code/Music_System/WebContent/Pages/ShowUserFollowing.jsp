...
<title>User following you</title>
...
<body>
<form name="showUserFollowing" method="post" action="UnfollowUserController">
<table align="right" >
	<tr>
		<td align="right"><a href="SignoutController">sign out</a>&nbsp;&nbsp;&nbsp;<a href="HomePageController">homepage</a></td>
	</tr>
</table>
	<%if(null!=request.getAttribute("noUserSelected") && request.getAttribute("noUserSelected").equals("true")){ %>
		<center><font color="red">please select atleast one user to unfollow</font></center>
	<%} 
		request.setAttribute("noUserSelected", "false");%>
	<%List<UserBean> userBeanFollowingList= (List<UserBean>)request.getAttribute("userBeanFollowingList");
	if(null!=userBeanFollowingList && !userBeanFollowingList.isEmpty()){%>
		<center>Users following you</center><br/><br/><br/><br/>
		<table align="center" id="tfhover" class="tftable" border="1">
			...
			<%for(UserBean userBean:userBeanFollowingList){ %>
			<tr>
				<td align="center"><input type="checkbox" name="unfollowUserSelected" value=<%=userBean.getUserid() %>></td>
				<td align="center"><%=userBean.getFirstName() %> <%=userBean.getLastName() %></td>
				<td align="center"><%=userBean.getCity() %></td>
				<td ailgn="center"><%=userBean.getState() %></td>
			</tr>
			<%} %>
			<tr></tr>
			<tr></tr>
			...
			<tr></tr>
			<tr>
				<td align="center" colspan=4><input type="submit" value="unlike" class="buttonaddcon"></td>
				<!-- <td align="center" colspan=2><a href="/Music_System/Pages/userHomePage.jsp">homepage</a> -->
			</tr>	
		</table>
	<%}else{ %>
	<center>No users are currently following you, please visit this page later<br/><br/><br/>
	<!-- <a href="/Music_System/Pages/userHomePage.jsp">Go back</a> -->
	</center>
	
	<%} %>
</form>
<div id="footer"><br/><br/><br/><br/><br/>
Copyright &copy 2014 Cocertblogger
</div>
</body>
</html>