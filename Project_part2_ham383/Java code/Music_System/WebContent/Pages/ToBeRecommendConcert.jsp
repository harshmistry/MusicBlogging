...
<title>COncerts you can recommend</title>
<center>Concerts you can recommend</center>
...
<body>
<form name="toBeRecommendedConcert" method="post" action="CreateReccomController">
	<table align="right">
	<tr>
	...
	<br/><br/><br/><br/><br/>
	<%List<ConcertDetailsBean> toBeRecommendCncrtList=(List<ConcertDetailsBean>)request.getAttribute("toBeRecomendList");
	if(null!=toBeRecommendCncrtList && !toBeRecommendCncrtList.isEmpty()){
		if(null!=request.getAttribute("concertNotSelected") && request.getAttribute("concertNotSelected").equals("true")){%>
		<center><font color="red">Please select one concert to create list</font></center>
		<% request.setAttribute("concertNotSelected", "false");
		   } %>
	<table align="center" id="tfhover" class="tftable" border=1>
		<tr>
			...
			<%for(ConcertDetailsBean concertDetailsBean:toBeRecommendCncrtList){ %>
			<tr>
				<td align="center"><input type="radio" name="cncrtIdSelctdToRcmd" value=<%=concertDetailsBean.getConcert_id() %>></td>
			...
			<%} %>
			<tr>
				<td align="center" colspan=10><input type="submit" value="Create Recommendation" class="button"></td>
			</tr>
	</table>
	<%}else{ %>
	<center>No concerts found to recommend, please visit later</center>
	<%} %>
</form>
