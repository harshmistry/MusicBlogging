...
<title>User's following you</title>
<center>User's following you</center>
...
<body>
<form name="showUserFollowArtist" method="post" action="">
	<table align="right">
		<tr>
	...
	<%List<UserBean> userFollowArtistList=(List<UserBean>)request.getAttribute("userFollowArtistList"); 
	if(null!=userFollowArtistList && !userFollowArtistList.isEmpty()){%>
	<table align="center" id="tfhover" class="tftable" border=1>
		...
		<%for(UserBean userBean:userFollowArtistList){ %>
		<tr>			
	...
	<%}else{ %>
	<center>No user's are following you, please visit again later</center>
	<%} %>
</form>
