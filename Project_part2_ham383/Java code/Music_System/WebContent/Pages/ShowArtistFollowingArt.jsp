...
<body>
<form name="recommendedArtistForArtist" method="post" action="ArtistYouAreFollowCntllr">
	<table align="right">
	<tr>
		<td align="right"><a href="SignoutController">sign out</a>&nbsp;&nbsp;&nbsp;<a href="ArtistHomePgContllr">homepage</a></td>
	</tr>
	</table><br/><br/><br/><br/>
	<%List<UserBean> artistFllwngArtistList = (List<UserBean>)request.getAttribute("artistFllwngArtistList"); %>
	<%if(null!=artistFllwngArtistList && !artistFllwngArtistList.isEmpty()){ 
		...
		<table align="center" border=1 width=50% id="tfhover" class="tftable">
			...
			<%for(UserBean userBean: artistFllwngArtistList){%>
					<tr>
						<td><input type="checkbox" name="selArtistToUnFollow" value=<%=userBean.getUserid() %>></td>
			...
			<tr></tr>
			<tr>
				<td align="center" colspan=5><input type="submit" value="unfollow" class="button"></td>		
			</tr>	
		</table>
	<%}else{ %>
		<center>You are currently not following any artist's</center>
	<%} %>
</form>
</body>
</html>