...
<center>Some artist you may want to follow</center>
...
<body>
<form name="followArtistSignUpForm" method="post" action="FollowArtistSignUpController">
<%List<List<UserBean>> reccomArtistList = (List<List<UserBean>>)request.getAttribute("reccoArtistList"); %>
	<%if(null!=reccomArtistList && !reccomArtistList.isEmpty()){ %>
		<table align="center" border=1 width=50% id="tfhover" class="tftable">
			...
			<%for(List<UserBean> userList:reccomArtistList){ 
				for(UserBean userBean: userList){%>
					<tr>
						<td><input type="checkbox" name="reccomAtristSelected" value=<%=userBean.getUserid() %>></td>
