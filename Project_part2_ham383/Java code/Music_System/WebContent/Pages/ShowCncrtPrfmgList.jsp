...
<body>
<form name="showConcrtPrfmd" method="post" action="/Music_System/EditCncrtCntllrList">
	<table align="right">
		<tr>
	...
	<table align="center" border=1 id="tfhover" class="tftable">
				...
				<%for(ConcertDetailsBean concertDetailsBean:cncrtPrfmgList){ %>
					<tr>
						<td align="center"><input type="radio" name="editConcertInfoId" value=<%=concertDetailsBean.getConcert_id() %>></td>						
						<td align="center"><input type="text" name="concertnameEdit" value=<%=concertDetailsBean.getConcert_name() %> class="inputs" disabled></td>				
					</tr>
				<%}%>
				<tr>
					<td align="center" colspan=2><input type="submit" value="Edit concert" class="button"></td>
				</tr>
	<%}else{ %>
