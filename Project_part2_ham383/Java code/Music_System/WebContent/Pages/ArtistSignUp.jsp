...
<body>
<form name="selMusicArtistSignUp" method="post" action="ArtistSignUpCntllr">
	...
	<table align="center" border=1 width=50% id="tfhover" class="tftable">
		<%if(null!=request.getAttribute("multipleCatSel") && request.getAttribute("multipleCatSel").equals("true")){ %>
		<tr>
			<td align=center colspan=6>Please select only one category and sub category</td>
		</tr>
		<%request.setAttribute("multipleCatSel","false");} %>
		<tr>
		...
		<%} %>
		<tr>
			<td colspan=3 align="center"><input type="submit" value="Select" class="button"></td>
