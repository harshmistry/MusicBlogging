...
<body>
<form name="recommendedArtistForm" method="post" action="RecommendedArtistConstroller">
	<table align="right">
	<tr>
		<td align="right"><a href="SignoutController">sign out</a>&nbsp;&nbsp;&nbsp;<a href="HomePageController">homepage</a></td>
	</tr>
	</table><br/><br/><br/><br/>
	<%List<UserBean> recommendedArtistList = (List<UserBean>)request.getAttribute("recommendedArtistList"); %>
	<%if(null!=recommendedArtistList && !recommendedArtistList.isEmpty()){ 
		...
		<table align="center" border=1 width=50% id="tfhover" class="tftable">
			...
			<%for(UserBean userBean: recommendedArtistList){%>
					<tr>
						<td><input type="checkbox" name="reccomdedAtristSelected" value=<%=userBean.getUserid() %>></td>
